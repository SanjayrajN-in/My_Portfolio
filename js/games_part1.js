...
function initMemoryGame() {
    ...
    const cardContent = {
        ...
        shapes: ['â—', 'â– ', 'â–²', 'â™¦', 'â˜…', 'â™ ', 'â™£', 'â™¥', 'â—†', 'â–¼', 'â—€', 'â–¶', 'â–²', 'â–¼', 'â—Š', 'â—‹', 'â–¡', 'â–³'],
        numbers: ['â‘ ', 'â‘¡', 'â‘¢', 'â‘£', 'â‘¤', 'â‘¥', 'â‘¦', 'â‘§', 'â‘¨', 'â“ª', 'â‘ª', 'â‘«', 'â‘¬', 'â‘­', 'â‘®', 'â‘¯', 'â‘°', 'â‘±'],
        symbols: ['âš¡', 'â­', 'â¤ï¸', 'ðŸ”¥', 'ðŸ’Ž', 'ðŸŒŸ', 'âš½', 'ðŸŽµ', 'ðŸ””', 'âš–ï¸', 'ðŸŽ¯', 'ðŸ†', 'ðŸŽª', 'ðŸŽ¨', 'ðŸŽ­', 'ðŸŽ¸', 'ðŸŽº', 'ðŸŽ»'],
        letters: ['â’¶', 'â’·', 'â’¸', 'â’¹', 'â’º', 'â’»', 'â’¼', 'â’½', 'â’¾', 'â’¿', 'â“€', 'â“', 'â“‚', 'â“ƒ', 'â“„', 'â“…', 'â“†', 'â“‡'],
        emojis: ['ðŸŽ®', 'ðŸŽ¯', 'ðŸŽ²', 'ðŸŽª', 'ðŸŽ¨', 'ðŸŽ­', 'ðŸŽ¸', 'ðŸŽº', 'ðŸŽ»', 'ðŸŽ¹', 'ðŸŽ¬', 'ðŸŽ¤', 'ðŸŽ§', 'ðŸŽ¼', 'ðŸŽµ', 'ðŸŽ¶', 'ðŸŽŠ', 'ðŸŽ‰']
    };
    ...
    function advanceToNextLevel() {
        ...
        if (currentIndex < difficulties_order.length - 1) {
            ...
            updateStatus(`ðŸ† MASTER LEVEL COMPLETED! ðŸ†<br>You've conquered all difficulty levels!<br>Final Score: ${gameState.score}`, 'success');
        }
    }
    ...
    function checkAchievements() {
        ...
        if (gameState.moves <= gameState.totalPairs * 2) {
            achievements.push('ðŸŽ¯ Perfect Memory - Completed with minimal moves!');
        }
        
        if (gameState.gameTime <= 30) {
            achievements.push('âš¡ Speed Demon - Completed in under 30 seconds!');
        }
        
        if (gameState.hintsUsed === 0) {
            achievements.push('ðŸ§  Pure Genius - No hints needed!');
        }
        
        if (gameState.difficulty === 'master') {
            achievements.push('ðŸ‘‘ Master Mind - Conquered the ultimate challenge!');
        }
    ...
    function handleGameCompleteEnhanced() {
        ...
        if (achievements.length > 0) {
            setTimeout(() => {
                ...
                updateStatus(`ðŸ† ACHIEVEMENTS UNLOCKED! ðŸ†<br>${achievementText}`, 'success');
            }, 4000);
        }
...
function initTetris() {
    ...
    function drawGameStateMessages() {
        ...
        if (gameState === 'waiting') {
            ...
            ctx.font = '16px Arial';
            ctx.fillText('Press SPACE or â–¶ï¸ button to resume', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 40);
